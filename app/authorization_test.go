...
func TestHasPermissionToCategory(t *testing.T) {
	...
	categories, err := th.App.GetSidebarCategories(th.Context, th.BasicUser.Id, th.BasicTeam.Id)
	require.Nil(t, err)
	...
	categories2, err := th.App.GetSidebarCategories(th.Context, th.BasicUser2.Id, th.BasicTeam.Id)
	require.Nil(t, err)
